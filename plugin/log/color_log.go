...
func Info(s string, a ...interface{}) {
	...
	grey(time.Now().Format("2006-01-02 15:04:05")+" "+s+"\n", a...)
}

func Warn(s string, a ...interface{}) {
	yellow := color.New(color.FgYellow).PrintfFunc()
	yellow(time.Now().Format("2006-01-02 15:04:05")+" "+s+"\n", a...)
}

func Succ(s string, a ...interface{}) {
	cyan := color.New(color.FgGreen).PrintfFunc()
	cyan(time.Now().Format("2006-01-02 15:04:05")+" "+s+"\n", a...)
}

func Err(s string, a ...interface{}) {
	red := color.New(color.FgRed).PrintfFunc()
	red(time.Now().Format("2006-01-02 15:04:05")+" "+s+"\n", a...)
}
